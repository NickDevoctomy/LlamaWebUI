...
Implement runtime rollback, including candidate validation, one-click return to the previous runtime, and removal guards. Do not use the 93.7 GB target for routine acceptance.
