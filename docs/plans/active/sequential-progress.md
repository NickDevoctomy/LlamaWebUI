...
**Current slice:** 7.1 — Backup and restore
...
- Phase 7: In progress — slice 7.1 is next.
...
Begin Phase 7 slice 7.1 — backup and restore. Do not begin Phase 7.2 until the backup/restore gate passes.

Suggested commit: `docs: complete authenticated client onboarding guidance`.
