...
**Current slice:** 7.2 — Accessibility and responsive hardening
...
- Phase 7: In progress — slice 7.1 complete; slice 7.2 is next. See `notes/0021-phase-7-1-backup-restore.md`.
...
Begin Phase 7 slice 7.2 — accessibility and responsive hardening. Do not begin Phase 7.3 until the accessibility/responsive gate passes.

Suggested commit: `feat: add bounded atomic database backup and restore`.
